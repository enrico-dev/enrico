...
//!
//! For Nek5000, lelg is the compile-time constant for the maximum number of global elements.  At
//! runtime, the user will choose an actual number of global elements (nelg) for their
//! problem, which must be <= lelg.
//!
...
//!
//! For Nek5000, lelt is the compile-time constant for the maximum number of local elements.  At
//! runtime, the user will choose an actual number of local elements (nelg) for their
//! problem, which must be <= lelt.
//!
...
//!
//! For Nek5000, lx1 is the compile-time constant for the maximum number GLL gridpoints in the
//! x-direction.  At runtime, the user will choose an actual number of GLL gridpoints for their
//! problem, which must be <= lx1.
//!
...
//!
//! The units of heat must match on the unit system that was used to setup the Nek5000 problem
//! (presumably W/cm^3). The caller must handle any necessary conversions.
//!
//! \param local_elem A local element ID

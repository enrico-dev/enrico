...
//! \param[out] sub_comm A new internode comm with the desired number of procs per node
//! \param[out] intranode_comm A new intranode comm wil procs in the same node
